...
def depth_map(imgL):
    ...
    return cv2.cvtColor(imgL, cv2.COLOR_BGR2GRAY)

path_dir = 'YOLO Weights'
...
while True:
    ...
    """
    left_rectified= leftFrame    # print("After rectification: ")
    # plotting
    # f, ax = plt.subplots(1,2, figsize=(12, 3))
    ...
    disp_matrix = depth_map(leftFrame)  # Get the disparity map
    #print(disp_matrix)
